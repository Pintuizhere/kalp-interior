<!-- Founder Section -->
<section class="founder-section" style="padding: 100px 0; background-color: var(--bg-white);">
    <div class="container" style="max-width: 1200px;">
        <div class="founder-content-wrapper">
            ...
            <div class="founder-info-col">
                <div class="section-subtitle" style="text-transform: none; font-size: 1rem; color: var(--accent-color); font-weight: 600; margin-bottom: 20px;">
                    <span style="display: inline-block; width: 10px; height: 10px; background-color: var(--accent-color); border-radius: 50%; margin-right: 10px;"></span> Our Founder
                </div>
                
                <h2 class="founder-heading">Vision. Values. Leadership.<br>The Foundation of Our Journey.</h2>
                <div class="founder-separator"></div>
                
                <p class="founder-description">Our founder's vision and leadership are the driving forces behind our commitment to excellence. With a passion for real estate and a people-first approach, he established this company to create spaces that inspire, build trust, and deliver lasting value.</p>
                ...
                <div class="founder-features">
                    <div class="founder-feature">
                        ...
                        <h5>Visionary Mindset</h5>
                        <p>A forward-thinking leader with a clear vision for growth and impact.</p>
                    </div>
                    <div class="founder-feature">
                        <div class="feature-icon-circle">
                        ...
                        <h5>People First</h5>
                        <p>Believes in empowering people and building strong, lasting relationships.</p>
                    </div>
                    <div class="founder-feature">
                        <div class="feature-icon-circle">
                        ...
                        <p>Dedicated to delivering quality, integrity, and exceptional experiences.</p>
                    </div>
                </div>
